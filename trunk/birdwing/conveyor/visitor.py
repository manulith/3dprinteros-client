...
class Visitor(object):
    def visit(self, target, *args, **kwargs):
        """
        This will walk the inheritance tree until it finds a function that 
        matches the string accept_<SOME_CLASS_NAME>, where <SOME_CLASS_NAME>
        if the name of a class that is either this base class or a 
        superclass.
        """
